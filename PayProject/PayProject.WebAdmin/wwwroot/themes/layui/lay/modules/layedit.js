...
layui.define(["layer", "form", "code"], function (t) {
    ...
    s.prototype.set = function (t) {
        ...
        s.prototype.setCursorText = function (index, content) {
            var iframeWin = d(index);
            if (!iframeWin[0]) return;
            try {
                var range = p(iframeWin[0].document);
                h.call(iframeWin[0], 'div', {
                    text: content
                }, range);
            }
            catch (err) {
    ...
    var r = function (t, e, n) {
        ...
        a.css({
            ...
            r.append(d), r.append(f), c.attr("contenteditable", "true").css({
                "min-height": n.height
            }).html(e.value || ""), u.apply(l, [s, a, e, n]), g.call(l, s, t, n)
        })
    },
        d = function (t) {
                                ...
                                layui.use("upload", function (e) {
                                    ...
                                    "" == s.url && n.msg("上传接口配置错误！"), e.render({
                                        ...
                                        before: function (t) {
                                            ...
                                            if (n.close(i), 0 == t.code) t.data = t.data || {}, o.val(t.data.src), a.val(t.data.name), s.done(t);
                                        ...
                                        return "" == i.url && n.msg("图片上传接口配置错误！"), layui.use("upload", function (e) {
                                            ...
                                            e = layui.upload, e.render({
                                                ...
                                                before: function (t) {
                                                    ...
                                                    if (n.close(l), 0 == t.code) t.data = t.data || {}, o.val(t.data.src), a.val(t.data.name);
                ...
                r = n.open({
                    ...
                    success: function (i, o) {
                        l.render("select"), l.on("submit(layedit-code-yes)", function (i) {
                            n.close(t.index), a && a(i.field, e.hide, e.
                                default)
                        })
                    }
                });
