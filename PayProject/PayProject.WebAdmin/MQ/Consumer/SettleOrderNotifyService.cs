...
{
    public class SettleOrderNotifyService : IHostedService, IDisposable
    {
        private readonly ILogger _logger;
        private readonly IConnection _rabbitConnection;
        private readonly IModel _channel;

        public SettleOrderNotifyService(ILogger<PayOrderNotifyService> logger, IConnection rabbitConnection)
        {
            _logger = logger;
        ...
        public Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            consumer.Received += (model, ea) =>
            {
                ...
                try
                {
                    var msg = JsonConvert.DeserializeObject<SettleOrderNotifyMsg>(Encoding.UTF8.GetString(ea.Body));
                    _channel.BasicAck(ea.DeliveryTag, false);
                    SettleOrderBll._.SendNotify(msg.orderid);
                }
